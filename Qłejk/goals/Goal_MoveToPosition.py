...
class Goal_MoveToPosition:

	def __init__(self, own, destination):
		self.type = "moveToPosition"
		self.owner = own
	...
	def activate(self):
		self.status = "active"
		self.owner.path = self.owner.pathPlanner.createPathToPosition(self.destination)
